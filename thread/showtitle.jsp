<html>
 <head><script> function sendCurrentDom(){
	var domInfo = 
	 ...
	 send(new Array(, /showtitlejsp':::ENTER', new Array(addVariable('domInfo', domInfo))));
...
function show_title() {
  send(new Array('/showtitlejsp.show_title', ':::ENTER', new Array(addVariable('dragLayer', dragLayer), addVariable('temp_trace', temp_trace), addVariable('tempdata', tempdata), addVariable('trace_author_right', trace_author_right), addVariable('trace_left', trace_left), addVariable('trace_right', trace_right))));
  ...
  send(new Array('/showtitlejsp.anonymous115', ':::ENTER', new Array(addVariable('data', data), addVariable('dragLayer', dragLayer), addVariable('i', i), addVariable('marker_y', marker_y), addVariable('temp_trace', temp_trace), addVariable('tempdata', tempdata), addVariable('traceIndices', traceIndices), addVariable('trace_author_right', trace_author_right), addVariable('trace_left', trace_left), addVariable('trace_right', trace_right))));
  ...
  send(new Array('/showtitlejsp.anonymous115', ':::EXIT118', new Array(addVariable('data', data), addVariable('dragLayer', dragLayer), addVariable('i', i), addVariable('marker_y', marker_y), addVariable('temp_trace', temp_trace), addVariable('tempdata', tempdata), addVariable('traceIndices', traceIndices), addVariable('trace_author_right', trace_author_right), addVariable('trace_left', trace_left), addVariable('trace_right', trace_right))));
});
  TESTER.on('plotly_unhover', function(data) {
  send(new Array('/showtitlejsp.anonymous132', ':::ENTER', new Array(addVariable('data', data), addVariable('dragLayer', dragLayer), addVariable('temp_trace', temp_trace), addVariable('tempdata', tempdata), addVariable('trace_author_right', trace_author_right), addVariable('trace_left', trace_left), addVariable('trace_right', trace_right), addVariable('update', update))));
  dragLayer.style.cursor = '';
  var update = {opacity: 1};
  Plotly.restyle(TESTER, update);
  send(new Array('/showtitlejsp.anonymous132', ':::EXIT137', new Array(addVariable('data', data), addVariable('dragLayer', dragLayer), addVariable('temp_trace', temp_trace), addVariable('tempdata', tempdata), addVariable('trace_author_right', trace_author_right), addVariable('trace_left', trace_left), addVariable('trace_right', trace_right), addVariable('update', update))));
});
  TESTER.on('plotly_click', function(data) {
  send(new Array('/showtitlejsp.anonymous141', ':::ENTER', new Array(addVariable('data', data), addVariable('dragLayer', dragLayer), addVariable('m', m), addVariable('temp_trace', temp_trace), addVariable('tempdata', tempdata), addVariable('trace_author_right', trace_author_right), addVariable('trace_left', trace_left), addVariable('trace_right', trace_right))));
  console.log(data);
  ...
  send(new Array('/showtitlejsp.anonymous141', ':::EXIT143', new Array(addVariable('data', data), addVariable('dragLayer', dragLayer), addVariable('m', m), addVariable('temp_trace', temp_trace), addVariable('tempdata', tempdata), addVariable('trace_author_right', trace_author_right), addVariable('trace_left', trace_left), addVariable('trace_right', trace_right))));
});
  send(new Array('/showtitlejsp.show_title', ':::EXIT141', new Array(addVariable('dragLayer', dragLayer), addVariable('temp_trace', temp_trace), addVariable('tempdata', tempdata), addVariable('trace_author_right', trace_author_right), addVariable('trace_left', trace_left), addVariable('trace_right', trace_right))));
}
</script>
 </head>
 <body></body>
